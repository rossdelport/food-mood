...
export default function JournalEntryScreen() {
  ...
  const linkOptions: JournalLink[] = WEEK.map((d) => ({ label: `${d.day} meals` }));
...
const styles = StyleSheet.create({
  ...
  status: { fontFamily: fonts.regular, fontSize: 11.5, color: colors.ink3 },

...
const styles = StyleSheet.create({
  ...
  notifBody: { fontFamily: fonts.regular, fontSize: 13, lineHeight: 18, color: colors.ink2, marginTop: 1 },
  ...
  valueCaption: { fontFamily: fonts.regular, fontSize: 12.5, color: colors.ink3 },

...
const styles = StyleSheet.create({
  ...
  tagline: { fontFamily: fonts.regular, fontSize: 13.5, color: colors.ink3, marginTop: 6 },
  taglinePlaceholder: { fontFamily: fonts.serifItalic },
  tagInput: { marginTop: 7, textAlign: 'center', fontFamily: fonts.regular, fontSize: 13.5, color: colors.ink2, borderBottomWidth: 1, borderBottomColor: colors.line, width: 220, paddingVertical: 2 },
  ...
  help: { fontFamily: fonts.regular, fontSize: 11.5, color: colors.ink3, lineHeight: 18, marginTop: 10, marginHorizontal: 2 },
  reminderHead: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', marginTop: 10, marginBottom: 6 },
  reminderCaption: { fontFamily: fonts.regular, fontSize: 12.5, color: colors.ink3 },

...
const styles = StyleSheet.create({
  ...
  intro: { fontFamily: fonts.regular, fontSize: 13.5, lineHeight: 21, color: colors.ink2, marginTop: 10 },
  ...
  notifApp: { fontFamily: fonts.semibold, fontSize: 12, color: colors.ink1 },
  notifNow: { fontFamily: fonts.regular, fontSize: 10.5, color: colors.ink3 },
  notifBody: { fontFamily: fonts.regular, fontSize: 12.5, color: colors.ink2, marginTop: 1 },
  notifCaption: { fontFamily: fonts.serifItalic, fontSize: 11.5, color: colors.ink3, marginTop: 8, marginHorizontal: 2 },
  ...
  listCount: { fontFamily: fonts.regular, fontSize: 11.5, color: colors.ink3 },

...
const styles = StyleSheet.create({
  ...
  subtitle: { fontFamily: fonts.regular, fontSize: 13, color: colors.ink3, marginTop: 6 },
  iconBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.chip, alignItems: 'center', justifyContent: 'center' },
  empty: { fontFamily: fonts.serifItalic, fontSize: 13.5, color: colors.ink3, textAlign: 'center', paddingVertical: 60, paddingHorizontal: 30 },
  ...
  rangeText: { fontFamily: fonts.medium, fontSize: 12, color: colors.ink2 },
